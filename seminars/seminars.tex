...
\clearpage\phantomsection\stepcounter{section}\addcontentsline{toc}{section}{\thesection\quad Geometria de Poisson: primeira aula}\addtocontents{toc}{\hspace{1em}\textit{Henrique Bursztyn, \hspace{.2 em}IMPA,\hspace{.5em}March 11,13, 2025, IMPA course}\par}
